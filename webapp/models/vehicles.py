...
class Vehicle(object):
    ...
    def __init__(self, id, vehicle_type, group, name, desc):
        self.id = id
...
def _add(id, vehicle_type, group, name, desc):
    registry.add(Vehicle(id, vehicle_type, group, name, desc))

_add('aav_tunguska', AIR_DEFENSE, STATION, 'Tunguska-M1',
...
_add('aav_type95', AIR_DEFENSE, STATION, 'Type 95',
...
_add('ats_hj8', GROUND_DEFENSE, STATION, 'HJ-8',
...
_add('ats_tow', GROUND_DEFENSE, STATION, 'BGM-71',
...
_add('chhmg_kord', GROUND_DEFENSE, STATION, '6P50',
...
_add('ch_bipod', GROUND_DEFENSE, STATION, '?', '?')
...
_add('hmg_m2hb', GROUND_DEFENSE, STATION, 'M2',
...
_add('igla_djigit', AIR_DEFENSE, STATION, '9K38',
...
_add('mec_bipod', GROUND_DEFENSE, STATION, '?', '?')
...
_add('us_bipod', GROUND_DEFENSE, STATION, '?', '?')

_add('usaas_stinger', AIR_DEFENSE, STATION, 'FIM-92',
...
_add('usaav_m6', AIR_DEFENSE, STATION, 'M6',
...
_add('wasp_defence_front', AIR_DEFENSE, STATION, 'CV-7',
...
_add('wasp_defence_back', AIR_DEFENSE, STATION, 'CV-7',
'USS Wasp (CV-7) was a United States Navy aircraft carrier. The eighth Navy ship of that name, she \
was the sole ship of her class. Built to use up the remaining tonnage allowed to the U.S. for \
aircraft carriers under the treaties of the time, she was built on a reduced-size version of the \
Yorktown-class hull.')
